...
class FG_eval {
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    fg[0] = 0;
    CppAD::AD<double> cte_cost = 0;
    CppAD::AD<double> epsi_cost = 0;
    CppAD::AD<double> v_cost = 0;
    CppAD::AD<double> delta_cost = 0;
    CppAD::AD<double> a_cost = 0;
    CppAD::AD<double> x_cost = 0;
    CppAD::AD<double> y_cost = 0;
    CppAD::AD<double> gap_delta_cost = 0;
    CppAD::AD<double> gap_a_cost = 0;
    ...
    std::cout << "cte cost " << cte_cost << std::endl;
    std::cout << "epsi cost " << epsi_cost << std::endl;
    ...
    std::cout << "gap delta cost " << gap_delta_cost << std::endl;
    std::cout << "gap a cost " << gap_a_cost << std::endl;

    fg[0] = cte_cost + epsi_cost + v_cost + delta_cost + a_cost + gap_delta_cost + gap_a_cost;
